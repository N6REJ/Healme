...
local function AddSpell(spellID)
	...
	table.insert(Healme_Spell.Name, name)
end
...
function Healme_InitSpells(class, race)
...
function Healme_CanCureDebuff(debuffType)
...
function Healme_ShowDebuffButtons(Profile, frame, debuffTypes)
